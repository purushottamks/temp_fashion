                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-3" id="menu_container">

                                <div class="row">
                                    <div id="menu_right_scroll">
                                    ...
                                    <div class="col-md-12" style="padding: 5px; border: 2px solid grey">
                                        ...
                                        <div class="panel-body" style="max-height: 743px;">
                                            ...
                                            <div class="select-choice selected" data-tab-id="33" data-option-id="870" data-parameter-id="display-option-383">
                                                ...
                                                <div class="option-radio-button">
                                                    <input type="radio" name="distinct_stitch" value="yes" onclick="set_distinct_stitch(this)">
                                                </div>
                                            </div>
                                            ...
                                            <div class="select-choice" data-tab-id="33" data-option-id="871" data-parameter-id="display-option-383">
                                                ...
                                                <div class="option-radio-button">
                                                    <input type="radio" name="distinct_stitch" value="no" onclick="set_distinct_stitch(this)">
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            <h4>Number Of Pockets</h4>
                                                ...
                                                <div class="select-choice selected" data-tab-id="34" data-option-id="1728" data-parameter-id="display-option-535">
                                                    ...
                                                    <div class="option-radio-button">
                                                        <input type="radio" name="pocket_numbers" onclick="number_of_pockets(this)" value="two">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="select-choice" data-tab-id="34" data-option-id="1729" data-parameter-id="display-option-535">
                                                    ...
                                                    <div class="option-radio-button">
                                                        <input type="radio" name="pocket_numbers" onclick="number_of_pockets(this)" value="three">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="select-choice" data-tab-id="34" data-option-id="1727" data-parameter-id="display-option-535">
                                                    ...
                                                    <div class="option-radio-button">
                                                        <input type="radio" name="pocket_numbers" onclick="number_of_pockets(this)" value="no">
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                    ...
                    <div class="col-md-6" id="suit_canvas" style="display: none">
                        <div id="suit_canvas_child">
                            <div id="trouser_alert" class="alert alert-info" style="display: none;">
                                <strong>Trousers</strong> are not selected
                            </div>
                            <div id="price_mobile" class="text-center" style="width: 80px; height: 80px; background-color: #00A8FF; border-radius: 50%">
                                <strong style="display:table; width: 100%; height:100%;">
                                    <span id="price_span" style="display:table-cell; vertical-align: middle; color: #ffffff; font-size: 14px;">${{price}}</span>
                                </strong>
                            </div>
                            <div id="suit">
                               {{suit}}
                        ...
                        <div id="view_selection">
                            <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div id="view_buttons">
                                        <div id="view_buttons_scroll">
                                            <div id="front_coat_view" onclick="front_coat()" class="col-md-12  btn-block btn-primary right_menu_buttons" >
                                                <strong>Front Coat</strong>
                                            </div>

                                            <div id="front_suit_view" onclick="front_suit()" class="col-md-12  btn-block btn-primary right_menu_buttons" >
                                                <strong>Front Suit</strong>
                                            </div>

                                            <div id="back_coat_view" onclick="back_coat()" class="col-md-12 btn-block btn-primary right_menu_buttons" >
                                                <strong>Back Coat</strong>
                                            </div>

                                            <div id="back_suit_view" onclick="back_suit()" class="col-md-12 btn-block btn-primary right_menu_buttons" >
                                                <strong>Back Suit</strong>
                                            </div>

                                            <div id="cart_btn" onclick="add_to_cart()" class="col-md-12 btn-block btn-success right_menu_buttons">
...
<script type="text/javascript" src="{{assets_url}}js/jquery.cookie.min.js"></script>
...
<script>
    ...
    let myCoat;
    if (typeof $.cookie('myCoat') == 'undefined' && $.cookie('myCoat') == null){ /// create cookie if not exist
        myCoat = { }; /// namespace
        myCoat.customProduct = 'customSuit';
        myCoat.product = 'three_piece'; /// three_piece, suit, jacket, trousers
        myCoat.fit = 'classic'; /// slim, classic
    ...
    $(document).ready(function () {
        ...
        update_params('customProduct','customSuit');
    ...
    function reload_page(target){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                let coat_html = response[0];
                let coat_price = response[1];
                $("#suit").empty();
                $("#suit").html(coat_html);
                $("#price_span").html('$'+coat_price);
                update_params('price', coat_price);
                show_side();
                trouser_adjustment();
                right_panel_adjustment();
            },
            error:function(response){
                console.log('error');
    ...
    function show_side(){
        if($.cookie('view_side') == 'front_coat'){
            front_coat();
        }else if($.cookie('view_side') == 'front_suit' ){
            front_suit();
        }else if($.cookie('view_side') == 'back_coat' ){
            back_coat()
        }else if($.cookie('view_side') == 'back_suit' ){
            back_suit();
        }else{
           front_coat();
        }
    ...
    function right_panel_adjustment(){
        let product = get_parameter_value('product');
    ...
    function pleats_adjustment(){
        $(".trousers_pleats").hide();
        $(".trousers_pleats."+get_parameter_value('fit')+"."+get_parameter_value('trousersPleats')).show();
        ////alert(".trousers_pleats."+get_parameter_value('fit')+"."+get_parameter_value('trousersPleats'));
    }
    ...
    function trouser_adjustment(){
        ...
        if($.cookie("view_side") == 'front_coat' || $.cookie("view_side") == 'front_suit' ){
            ...
            $(".trouser_back."+get_parameter_value('fit')+"."+get_parameter_value('trousersPressed')).show();
        }
    ...
    function add_to_cart(){
        ...
        $.ajax({
            url:"",
            type:'post',
            data:{ajax:1, action:'custom_to_cart', product_type:'custom', coatParams:coatString},
            success:function(response){
                console.log(response);
    ...
    function set_distinct_stitch(e){
        update_params('distinctStitch', $(e).val());
        console.log(myCoat);
    }

    function number_of_pockets(e){
        update_params('pockets', $(e).val());
        console.log(myCoat);
    }
