					...
					<div class="row">
						<div class="col-md-8 col-sm-7 col-xs-12">
							<div class="buttons-cart">
								<a href="{{base_url}}outlet/1/1">Continue Shopping</a>
							</div>
						</div>
							...
							<div class="cart_totals">
								...
								<table>
									...
									<tr class="shipping">
										<th>Shipping</th>
										<td>
											<p style="min-width: 80px;"><a class="shipping-calculator-button" href="#">{{shipping}}</a></p>
										</td>
									</tr>
...
<script>
    function removeFromCart(id){
        ...
        $.ajax({
            url:"",
            type:"post",
            data:{ajax:"1", action:"removeFromCart", productId:id},
            success:function(response){
                if(response == "removed_from_cart"){
	...
	function updateCart(e){
        ...
        $.ajax({
            url:"",
            type:"post",
            data:{ajax:"1", action:"updateCart", productId:productId, quantity:quantity},
            success:function(response){
	...
	function updateCustomCart(e){
        ...
        $.ajax({
            url:"",
            type:"post",
            data:{ajax:"1", action:"updateCustomCart", productId:productId, quantity:quantity},
            success:function(response){
                if(response == "cart_updated"){
                    window.location.href = base_url+"cart";
                }
