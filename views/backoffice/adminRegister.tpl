                        ...
                        <div class="vd_content-section clearfix">
                            <div class="vd_login-page">
                                <div class="heading clearfix">
                                    ...
                                    <h4 class="text-center font-semibold vd_grey">Register</h4>
                                </div>
                                        ...
                                        <form class="form-horizontal" id="login-form" action="" method="post" role="form">
                                            ...
                                            <div class="form-group  mgbt-xs-20">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-envelope"></i> </span>
                                                        <input type="text" placeholder="First Name" id="first_name" name="first_name" value="" class="required" required>
                                                    </div>
                                                    ...
                                                    <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-envelope"></i> </span>
                                                        <input type="text" placeholder="Last Name" id="last_name" name="last_name" value="" class="required" required>
                                                    </div>
                                                    ...
                                                    <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-envelope"></i> </span>
                                                        <input type="email" placeholder="Email" id="email" name="email" value="" class="required" required>
                                                    </div>
                                                    <div class="label-wrapper">
                                                        <label class="control-label sr-only" for="password">Password</label>
                                                    </div>
                                                    <div class="vd_input-wrapper" id="password-input-wrapper" > <span class="menu-icon"> <i class="fa fa-lock"></i> </span>
                                                        <input type="password" value="" placeholder="Password" id="password" name="password" onkeyup="validatePassword()" class="required" required>
                                                    </div>
                                                    <div class="label-wrapper">
                                                    ...
                                                    <div class="vd_input-wrapper" id="confirmPwd" >
                                                        ...
                                                        <input type="password" placeholder="Confirm Password" value="" id="confirmPassword" name="confirmPassword"  onkeyup="validatePassword()" class="required" required>
                                                    </div>
                                                    <span id="error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 text-center mgbt-xs-5">
                                                    <button class="btn vd_bg-green vd_white width-100" type="submit" id="submit_register" name="submit_register">Register</button>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12 text-center mgbt-xs-5">
                                                    <a class="btn vd_bg-green vd_white width-100" href="{{base_url}}adminLogin">Login</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
