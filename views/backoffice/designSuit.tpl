                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-magic"></i> </span> Design Suit </h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="panel-group" id="accordion">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class=""> Options </a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
                                                        <div class="panel-body">
                                                            ...
                                                            <form id="add_option">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Image</label>
                                                                    <input type="file" class="form-control" name="option" id="option">
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed"> Fit </a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseTwo" class="panel-collapse collapse" style="height: 0px;">
                                                        <div class="panel-body">
                                                            ...
                                                            <form id="add_option">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Options</label>
                                                                    <input type="file" class="form-control" name="image" id="fit_image">
                                                                </div>

                                                                <div class="form-group">
                                                                    <input type="submit" class="btn btn-success" name="submit_fit" >
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="collapsed"> Fabric </a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour" class="collapsed"> Lining </a>
                                                        </h4>
                                                    </div>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <form id="add_option">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="checkbox" class="" name="option" id="option">
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive" class="collapsed"> Buttoning </a>
                                                        </h4>
                                                    </div>
                                                            ...
                                                            <form id="add_option">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select  class="form-control" name="option" id="option">
                                                                        ...
                                                                        <option>Single Two</option>
                                                                        <option>Single Three</option>
                                                                        <option>Double Four</option>
                                                                        <option>Double Six</option>
                                                                    </select>
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseSix" class="collapsed"> Lapels </a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseSix" class="panel-collapse collapse" style="">
                                                        <div class="panel-body">
                                                            ...
                                                            <form id="add_option">
                                                                ...
                                                                <fieldset>
                                                                    <legend>Add Lapel Design</legend>
                                                                    <div class="form-group">
                                                                        <label>Add Lapel Design</label>
                                                                        <input type="text" class="form-control" name="option" id="option">
                                                                    </div>
                                                                </fieldset>

                                                                <fieldset>
                                                                    <legend>Add Design Options</legend>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" class="collapsed"> Pockets </a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseEight" class="collapsed"> Vents </a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseNine" class="collapsed"> Jacket Details </a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseNine" class="panel-collapse collapse" style="">
                                                        <div class="panel-body">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTen" class="collapsed"> Trouser Style </a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseTen" class="panel-collapse collapse" style="">
                                                        <div class="panel-body">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading vd_bg-green">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseEleven" class="collapsed"> Waistcoat </a>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseEleven" class="panel-collapse collapse" style="">
                                                        <div class="panel-body">
