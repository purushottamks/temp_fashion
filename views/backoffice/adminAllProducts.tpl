...
<div class="vd_body">
    ...
    <div class="modal fade" id="edit_product" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:85%">

            <div class="modal-header vd_bg-green vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                            class="fa fa-times"></i></button>
                <h4 class="modal-title" id="view_category_heading">View Product</h4>
            </div>

            <div class="modal-content">

                <div class="modal-body clearfix" id="edit_category_content">
                    <form id="edit_product_form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="product_price" name="product_price" value="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" id="custom" name="custom" value="">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" id="edit_product" name="edit_product" value="Update" class="btn btn-success">
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Products List </h3>
                                        </div>
...
<script>
    ...
    function show_product(e){
        ...
        var product_image = $(e).data('product_image');
        var thumbnail = $(e).data('thumbnail');
        var custom = $(e).data('custom');
        var product_category = $(e).data('product_category');
        $("#show_image").attr('src', base_url+'uploads/'+product_image);
        $("#product_id").val(product_id);
        $("#old_image").val(product_image);
    ...
    function delete_product(e){
        ...
        $.ajax({
            url:'',
            type:'post',
            data:{ajax:1, action:action, product_id:product_id},
