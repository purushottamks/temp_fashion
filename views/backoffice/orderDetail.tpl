                        ...
                        <div class="navbar-search vd_bg-black-30">
                            ...
                            <div class="pull-right search-config">
                                <a data-toggle="dropdown" href="javascript:void(0);" class="dropdown-toggle">
                                    <span class="prepend-icon vd_grey"><i class="fa fa-cog"></i></span></a>
                                ...
                                <div class="col-sm-9">
                                    <div class="panel widget light-widget">
                                        <div class="panel-body" style="padding:40px;">
                                            ...
                                            <div class="mgbt-xs-20"><img style="width:200px;" alt="logo" src="{{assets_url}}/img/logo.jpg"></div>
                                            <address>
                                                {{email}}
                                            </address>
                                            <br>
                                            ...
                                            <table class="table table-condensed table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-right  pd-10 "><span class="vd_green font-sm font-normal">{{total}}</span></th>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
