...
<div class="vd_body">
                ...
                <div class="modal-body clearfix" id="edit_category_content">
                    <form id="edit_form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="collection_name" name="collection_name" value="">
                        </div>

                        <div class="form-group">
                            <label for="collection_image">Collection Image</label>
                            <input type="file" id="collection_image" name="collection_image" value="">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" id="edit_collection" name="edit_collection" value="Update" class="btn btn-success">
                        </div>
    ...
    <div class="modal fade" id="view_collection" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
    ...
    function show_collection(e){
        let collection_id = $(e).data('collection_id');
        let collection_name = $(e).data('collection_name');
        let old_image = $(e).data('collection_image');
    ...
    function delete_collection(e){
        ...
        let collection_id = $(e).data('collection');
        $("#loading").modal('show');
        $.ajax({
            url:'',
            type:'post',
            data:{ajax:1, action:action, collection_id:collection_id},
            success:function(response){
                if(response == 'success'){
                    $("#row_"+collection_id).remove();
                }
                $("#loading").modal('hide');
            },
