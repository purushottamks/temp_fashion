...
<div class="vd_body">
    ...
    <div class="modal fade" id="edit_accessory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:85%">

            <div class="modal-header vd_bg-green vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                            class="fa fa-times"></i></button>
                <h4 class="modal-title" id="view_category_heading">View Accessory</h4>
            </div>

            <div class="modal-content">

                <div class="modal-body clearfix" id="edit_category_content">
                    <form id="edit_accessory_form" method="post" action="" enctype="multipart/form-data">

                        <input type="hidden" id="old_image" name="old_image" value="">
                        <input type="hidden" id="thumbnail" name="thumbnail" value="">
                        <input type="hidden" id="accessory_id" name="accessory_id" value="">

                        <div class="form-group">
                            <label for="accessory_name">Accessory Name</label>
                            <input type="text" id="accessory_name" name="accessory_name" value="">
                        </div>

                        <div class="form-group">
                            <label for="accessory_category">Accessory Category</label>
                        ...
                        <div class="form-group">
                            <label for="product_image">Accessory Image</label>
                            <input type="file" id="accessory_image" name="accessory_image" value="">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" id="edit_accessory_btn" name="edit_accessory" value="Update" class="btn btn-success">
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Accessories List </h3>
                                        </div>
...
<script>
    ...
    function show_accessory(e){
        var accessory_id = $(e).data('accessory_id');
        var accessory_name = $(e).data('accessory_name');
        var accessory_image = $(e).data('accessory_image');
        var thumbnail = $(e).data('thumbnail');
        var price = $(e).data('price');
        var accessory_category = $(e).data('accessory_category');
        $("#show_image").attr('src', base_url+'uploads/'+accessory_image);
        $("#accessory_id").val(accessory_id);
        $("#old_image").val(accessory_image);
        $("#thumbnail").val(thumbnail);
        $("#accessory_name").val(accessory_name);
        $("#price").val(price);
        $("#accessory_category").val(accessory_category);
        $("#edit_accessory").modal('show');
    }



    function delete_accessory(e){
        ...
        $.ajax({
            url:'',
            type:'post',
            data:{ajax:1, action:action, accessory_id:accessory_id},
            success:function(response){
                if(response == 'success'){
                    $("#row_"+accessory_id).remove();
                }
                $("#loading").modal('hide');
            },
