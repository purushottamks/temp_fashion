...
<div class="vd_body">
    ...
    <div class="modal fade" id="loading" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:200px !important; top:200px">
            <div class="modal-content">
                ...
                <div class="modal-body clearfix" id="edit_fabric_content">
    ...
    <div class="modal fade" id="edit_fabric" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:85%">

            <div class="modal-header vd_bg-green vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                            class="fa fa-times"></i></button>
                <h4 class="modal-title" id="view_fabric_heading">View Fabric</h4>
            </div>
                ...
                <div class="modal-body clearfix" id="edit_fabric_content">
                    <form id="edit_form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="fabric_name" name="fabric_name" value="">
                        </div>

                        <div class="form-group">
                            <label for="fabric_image">Fabric Image</label>
                            <input type="file" id="fabric_image" name="fabric_image" value="">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" id="edit_fabric" name="edit_fabric" value="Update" class="btn btn-success">
                        </div>
    ...
    <div class="modal fade" id="view_fabric" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:85% !important;">
            <div class="modal-content">
                ...
                <div class="modal-body clearfix" id="view_fabric_content">
...
<script>
    ...
    function show_fabric(e){
        let fabric_id = $(e).data('fabric_id');
        let fabric_name = $(e).data('fabric_name');
        let old_image = $(e).data('fabric_image');
        let old_thumbnail = $(e).data('thumbnail');
       $("#fabric_id").val(fabric_id);
       $("#fabric_name").val(fabric_name);
       $("#old_image").val(old_image);
       $("#thumbnail").val(old_thumbnail);
       $("#show_image").attr('src', base_url+"uploads/"+old_image);
       $("#edit_fabric").modal('show');
    }



    function delete_fabric(e){
        var action = $(e).data('action');
        var fabric_id = $(e).data('fabric_id');
        $("#loading").modal('show');
        $.ajax({
            url:'',
            type:'post',
            data:{ajax:1, action:action, fabric_id:fabric_id},
            success:function(response){
                if(response == 'success'){
                    $("#row_"+fabric_id).remove();
                }
                $("#loading").modal('hide');
            },
    ...
    function add_components(e){
        var action = $(e).data('action');
        var fabric_id = $(e).data('fabric_id');
       let coat_page =  base_url+'addCoat'+'/'+fabric_id;
       window.location.href = coat_page;
    }
