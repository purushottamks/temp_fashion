                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Lining Name</label>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Lining Thumb</label>
                                                    <div class="col-sm-7 controls">
                                                        <input type="file" name="thumbnail" id="thumbnail" placeholder="Image">
                                                        <span class="help-inline">Some hint here</span> </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Lining Image</label>
                                                    <div class="col-sm-7 controls">
