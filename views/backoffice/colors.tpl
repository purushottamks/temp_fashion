                            ...
                            <div class="vd_panel-header">
                                ...
                                <div class="vd_panel-menu  hidden-xs">
                                    <div class="menu no-bg vd_red" data-original-title="Start Layout Tour Guide"
                                        ...
                                        <span class="menu-icon font-md"><i class="fa fa-question-circle"></i></span></div>
                                    <!-- menu -->
                                </div>
                                <!-- vd_panel-menu -->
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Color </h3>
                                        </div>
                                    ...
                                    <div class="panel widget">
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"><span class="menu-icon"> <i
                                                            class="fa fa-dot-circle-o"></i> </span> Colors </h3>
                                        </div>
...
<script>
    function delete_color(e, id){
        $.ajax({
            url:"",
            type:"post",
            data:{ajax:1, action:"deleteColor", id:id},
            success:function(response){
                if(response == "color_deleted"){
                    $(e).closest('tr').remove();
                }
            },
