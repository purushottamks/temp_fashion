...
<div class="vd_body">
    ...
    <div class="modal fade" id="loading" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:200px !important; top:200px">
            <div class="modal-content">
                ...
                <div class="modal-body clearfix" id="edit_lining_content">
    ...
    <div class="modal fade" id="edit_lining" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:85%">

            <div class="modal-header vd_bg-green vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                            class="fa fa-times"></i></button>
                <h4 class="modal-title" id="view_lining_heading">View Lining</h4>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body clearfix" id="edit_lining_content">
                    <form id="edit_form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <input type="hidden" id="lining_id" name="lining_id" value="">

                        <div class="form-group">
                            <label for="cat_name">Lining Name</label>
                            <input type="text" id="lining_name" name="lining_name" value="">
                        </div>

                        <div class="form-group">
                            <label for="cat_image">Lining Image</label>
                            <input type="file" id="lining_image" name="lining_image" value="">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" id="edit_lining" name="edit_lining" value="Update" class="btn btn-success">
                        </div>
    ...
    <div class="modal fade" id="view_lining" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:85% !important;">
            <div class="modal-content">
                ...
                <div class="modal-body clearfix" id="view_lining_content">
...
<script>
    ...
    function show_lining(e){
       var lining_id = $(e).data('lining_id');
       var lining_name = $(e).data('lining_name');
       var old_image = $(e).data('lining_image');
       var old_thumbnail = $(e).data('thumbnail');
       $("#lining_id").val(lining_id);
       $("#lining_name").val(lining_name);
       $("#old_image").val(old_image);
       $("#thumbnail").val(old_thumbnail);
       $("#show_image").attr('src', base_url+"uploads/"+old_image);
       $("#edit_lining").modal('show');
    }


    function delete_lining(e){
        ...
        $.ajax({
            url:'',
            type:'post',
            data:{ajax:1, action:action, lining_id:lining_id},
            success:function(response){
                if(response == 'success'){
                    $("#row_"+lining_id).remove();
                }
                $("#loading").modal('hide');
            },
