                    ...
                    <div class="content-list content-image content-chat">
                        <ul class="list-wrapper no-bd-btm pd-lr-10">
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-2.jpg" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-3.jpg" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-4.jpg" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-5.jpg" alt="example image"></div>
                                    ...
                                    <div class="menu-badge">
                                        <span class="vd_grey font-sm"><i class="fa fa-mobile"></i></span></div>
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-6.jpg" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-7.jpg" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon">
                                        <img src="{{assets_url}}img/avatar/avatar-8.jpg" alt="example image"></div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        ...
                                        <div class="panel-heading vd_bg-grey">
                                            <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Add Fabric </h3>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Composition</label>
                                                    <div class="col-sm-7 controls">
                                                        <input type="text" name="composition" id="composition" placeholder="Composition">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Pattern</label>
                                                    <div class="col-sm-7 controls">
                                                        <input type="text" name="pattern" id="pattern" placeholder="Pattern">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Extra Price</label>
                                                    <div class="col-sm-7 controls">
                                                        <input type="number" name="extra_price" id="extra_price" placeholder="Price">
                                                        <span class="help-inline">Some hint here</span> </div>
                                                </div>
                                                ...
                                                <div class="form-group form-actions">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <button class="btn vd_btn vd_bg-green vd_white" name="submit" type="submit"><i class="icon-ok"></i> Save</button>
