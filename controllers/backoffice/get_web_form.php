...
?>
	...
	<?php if($row['webform_type']=='2'){?>
		<div class="modal-dialog" style="position: inherit">
			<div class="modal-content" style="background-color:#<?php echo $row['frame_bg_color']?> !important; width:<?php echo $row['frame_width']?>px; margin:0 auto !important">
				<div class="modal-header" style="display: block !important">
					...
					<h4 class="modal-title" style="color:#<?php echo $row['color_for_label']?> !important; display:block"><?php echo $row['webform_name']?></h4>
				</div>
	...
	<?php }else{?>
			<div class="modal-dialog" style="position: inherit">
				...
				<div class="modal-header"  style="display: block !important">
					<button type="button" data-dismiss="modal" class="close">&times;</button>
					<h4 class="modal-title" style="color: #'.$row['color_for_label'].'; display: block"><?php echo $row['webform_name']?></h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
